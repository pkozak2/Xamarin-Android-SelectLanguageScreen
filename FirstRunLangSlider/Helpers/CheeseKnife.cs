...
namespace Com.Lilarcor.Cheeseknife
{
    ...
    public static class Cheeseknife
    {
        ...
        const BindingFlags INJECTION_BINDING_FLAGS =
        ...
        {
            var resolveMethod = typeof(Cheeseknife).GetMethod(METHOD_NAME_RESOLVE_ANDROID_VIEW,
        ...
        static void InjectMethod(Type attributeType, MethodInfo method, object parent, View view, string eventName)
        {
            ...
            var eventParameterTypes = eventInfo.EventHandlerType.GetMethod(METHOD_NAME_INVOKE).GetParameters()
